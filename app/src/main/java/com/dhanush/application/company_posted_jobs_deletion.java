...
public class company_posted_jobs_deletion extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.company_post_jobs_deletion);
        ...
        DatabaseHelperCompany helper = new DatabaseHelperCompany(company_posted_jobs_deletion.this);
            ...
            public void onClick(View v) {
                ...
                if (mJobId.getText().toString().isEmpty() || mJobName.getText().toString().isEmpty() || mJobType.getText().toString().isEmpty() || mSalary.getText().toString().isEmpty()) {
                    ...
                    if(id==1) {
                        ...
                        helper.deletejob1(c);
                        Intent i = new Intent(company_posted_jobs_deletion.this, CompanyView_Posted_Jobs.class);
