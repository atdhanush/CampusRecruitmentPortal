...
public class delete_student_by_admin extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.delete_student_by_admin);

        /*code for spinner*/

        Spinner spinner = (Spinner) findViewById(R.id.department_spinner);
        ArrayAdapter<CharSequence> adapter = ArrayAdapter.createFromResource(delete_student_by_admin.this, R.array.department_spinner, android.R.layout.simple_spinner_item);
        adapter.setDropDownViewResource(android.R.layout.simple_spinner_dropdown_item);
        spinner.setAdapter(adapter);

        Spinner mspinner = (Spinner) findViewById(R.id.year_id);
        ArrayAdapter<CharSequence> madapter = ArrayAdapter.createFromResource(delete_student_by_admin.this, R.array.year_spinner, android.R.layout.simple_spinner_item);
        madapter.setDropDownViewResource(android.R.layout.simple_spinner_dropdown_item);
        mspinner.setAdapter(madapter);

        Spinner nspinner = (Spinner) findViewById(R.id.year1_id);
        ArrayAdapter<CharSequence> nadapter = ArrayAdapter.createFromResource(delete_student_by_admin.this, R.array.year_spinner, android.R.layout.simple_spinner_item);
        ...
        DatabaseHelper helper = new DatabaseHelper(delete_student_by_admin.this);
        ...
        mButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                else
                {
                    ...
                    helper.delete(c);
                    Intent i = new Intent(delete_student_by_admin.this,ManageStudentActivity.class);
