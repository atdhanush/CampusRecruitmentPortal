...
public class Admin_forgot_password  extends AppCompatActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        resetPassword.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (useremail.equals("")) {
                    Toast.makeText(Admin_forgot_password.this, "Please enter your registered Email ID", Toast.LENGTH_SHORT).show();
                } else {
                    ...
                    if (conformpswd.getText().toString().isEmpty()) {
                        ...
                        DatabaseHelperAdmin helper = new DatabaseHelperAdmin(Admin_forgot_password.this);
                        if (newpswd.getText().toString().isEmpty()) {
                            newpswd.requestFocus();
                            newpswd.setError("Password is required");
                            return;
                        ...
                        if (newpswd.getText().toString().equals(conformpswd.getText().toString())) {
                            try {
                                ...
                                Intent i = new Intent(Admin_forgot_password.this, login.class);
