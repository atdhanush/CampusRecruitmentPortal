...
//    private static final String TABLE_CREATE = "create table studentcontacts (id integer primary key not null , name text not null , uname text , uid text not null , emailId text not null , contactNo text not null , password text not null);";
 ...
 /*   public void insertStudentContact(StudentContact c)
    ...
    public ArrayList<String> searchEmail(String email)
    {
        ...
        list.add(cursor.getString(0)); //COLUMN_ID
        list.add(cursor.getString(1)); //COLUMN_NAME
        list.add(cursor.getString(2)); //COLUMN_UNAME
        list.add(cursor.getString(3));  //COLUMN_UID
        list.add(cursor.getString(4));  //COLUMN_EMAIL
        list.add(cursor.getString(5));  //COLUMN_CONTACTNO
        list.add(cursor.getString(6));  //COLUMN_PASSWORD
        list.add(cursor.getString(7));  //COLUMN_ADDRESS
        list.add(cursor.getString(8)); //,COLUMN_SSC,
        list.add(cursor.getString(9));  //,COLUMN_HSC,
        list.add(cursor.getString(10)); //COLUMN_GRADE
        list.add(cursor.getString(11)); //COLUMN_SKILL
        list.add(cursor.getString(12)); //,COLUMN_COMPANYNAME1,
        list.add(cursor.getString(13)); //COLUMN_COMPANYEMAIL1
        list.add(cursor.getString(14)); //COLUMN_JOB_ID1,
        list.add(cursor.getString(15)); //COLUMN_JOB_NAME1,
        list.add(cursor.getString(16)); //COLUMN_JOB_TYPE1
        list.add(cursor.getString(17)); //COLUMN_QUALIFIED1
        list.add(cursor.getString(18)); //COLUMN_COMPANYNAME2
        list.add(cursor.getString(19)); //COLUMN_COMPANYEMAIL2
        list.add(cursor.getString(20));   //COLUMN_JOB_ID2
        list.add(cursor.getString(21));  //COLUMN_JOB_NAME2
        list.add(cursor.getString(22));   //,COLUMN_JOB_TYPE2
        list.add(cursor.getString(23));  //,COLUMN_QUALIFIED2
        list.add(cursor.getString(24));  //COLUMN_COMPANYNAME3
        list.add(cursor.getString(25));   //COLUMN_COMPANYEMAIL3
        list.add(cursor.getString(26));   //COLUMN_JOB_ID3
        list.add(cursor.getString(27));  //COLUMN_JOB_NAME3,
        list.add(cursor.getString(28));  //COLUMN_JOB_TYPE3
        list.add(cursor.getString(29)); //COLUMN_QUALIFIED3,
        list.add(cursor.getString(30)); //COLUMN_COMPANYNAME4
        list.add(cursor.getString(31)); //,COLUMN_COMPANYEMAIL4,
        list.add(cursor.getString(32));    //COLUMN_JOB_ID4
        list.add(cursor.getString(33));   //COLUMN_JOB_NAME4
        list.add(cursor.getString(34));    //COLUMN_JOB_TYPE4
        list.add(cursor.getString(35));   //COLUMN_QUALIFIED4
...
// return contact list
    ...
    public void delete(StudentContact c)
    {
        db = this.getWritableDatabase();
        db.delete(TABLE_NAME, ROW_ID + "=" + c.id, null);
        db.close();
    }

    public void clearstatus1(StudentContact c)
    {
        db = this.getWritableDatabase();
        ContentValues values = new ContentValues();
        values.putNull(COLUMN_QUALIFIED1);
        db.update(TABLE_NAME,values,COLUMN_ID+" = ?",new String[]{
                String.valueOf(c.getId())
        });
        db.close();
    }
    public void status1(StudentContact c)
    {
        db=this.getWritableDatabase();
        ContentValues values = new ContentValues();
        int val = (c.getQualified1()) ? 1 : 0;
        values.put(COLUMN_QUALIFIED1, val);
        db.update(TABLE_NAME,values,COLUMN_ID+" = ?",new String[]{
                String.valueOf(c.getId())
        });
        db.close();
    ...
    public void clearstatus2(StudentContact c)
    {
        db = this.getWritableDatabase();
        ContentValues values = new ContentValues();
        values.putNull(COLUMN_QUALIFIED2);
        db.update(TABLE_NAME,values,COLUMN_ID+" = ?",new String[]{
                String.valueOf(c.getId())
        });
        db.close();
    ...
    public void status2(StudentContact c)
    {
        db=this.getWritableDatabase();
        ContentValues values = new ContentValues();
        int val = (c.getQualified2()) ? 1 : 0;
        values.put(COLUMN_QUALIFIED2,val);
        db.update(TABLE_NAME,values,COLUMN_ID+" = ?",new String[]{
                String.valueOf(c.getId())
        });
        db.close();
    ...
    public void clearstatus3(StudentContact c)
    {
        db = this.getWritableDatabase();
        ContentValues values = new ContentValues();
        values.putNull(COLUMN_QUALIFIED3);
        db.update(TABLE_NAME,values,COLUMN_ID+" = ?",new String[]{
                String.valueOf(c.getId())
        });
        db.close();
    }
    public void status3(StudentContact c)
    {
        db=this.getWritableDatabase();
        ContentValues values = new ContentValues();
        int val = (c.getQualified3()) ? 1 : 0;
        values.put(COLUMN_QUALIFIED3, val);
        db.update(TABLE_NAME,values,COLUMN_ID+" = ?",new String[]{
                String.valueOf(c.getId())
        });
        db.close();
    ...
    public void clearstatus4(StudentContact c)
    {
        db = this.getWritableDatabase();
        ContentValues values = new ContentValues();
        values.putNull(COLUMN_QUALIFIED4);
        db.update(TABLE_NAME,values,COLUMN_ID+" = ?",new String[]{
                String.valueOf(c.getId())
        });
        db.close();
    }
    public void status4(StudentContact c)
    {
        db=this.getWritableDatabase();
        ContentValues values = new ContentValues();
        int val = (c.getQualified4()) ? 1 : 0;
        values.put(COLUMN_QUALIFIED4, val);
        db.update(TABLE_NAME,values,COLUMN_ID+" = ?",new String[]{
                String.valueOf(c.getId())
        });
        db.close();
    ...
    public void applyForJobfromsearch(int x, String email, String grade, String skill, String companyName, String companyEmail, Integer id, String name, String type,StudentContact c)
    {
        db=this.getWritableDatabase();
        Cursor cursor = db.query(TABLE_NAME,new String[]{COLUMN_ID,COLUMN_NAME,COLUMN_UNAME,COLUMN_UID,COLUMN_EMAIL,COLUMN_CONTACTNO,COLUMN_PASSWORD,COLUMN_ADDRESS,COLUMN_SSC,COLUMN_HSC,COLUMN_GRADE,COLUMN_SKILL,COLUMN_COMPANYNAME1,COLUMN_COMPANYEMAIL1,COLUMN_JOB_ID1,COLUMN_JOB_NAME1,COLUMN_JOB_TYPE1,COLUMN_QUALIFIED1,COLUMN_COMPANYNAME2,COLUMN_COMPANYEMAIL2,COLUMN_JOB_ID2,COLUMN_JOB_NAME2,COLUMN_JOB_TYPE2,COLUMN_QUALIFIED2,COLUMN_COMPANYNAME3,COLUMN_COMPANYEMAIL3,COLUMN_JOB_ID3,COLUMN_JOB_NAME3,COLUMN_JOB_TYPE3,COLUMN_QUALIFIED3,COLUMN_COMPANYNAME4,COLUMN_COMPANYEMAIL4,COLUMN_JOB_ID4,COLUMN_JOB_NAME4,COLUMN_JOB_TYPE4,COLUMN_QUALIFIED4},COLUMN_EMAIL+"=?",new String[]{email},null,null,null,null);
        if(cursor!=null)
