...
*/
    ...
    public ArrayList<String> searchEmail(String email)
    {
        ...
        list.add(cursor.getString(23));
        list.add(cursor.getString(24));
    ...
    public void updatejobs1(CompanyContact c)
    {
        db=this.getWritableDatabase();
        ContentValues values = new ContentValues();
    ...
    public void updatejobs2(CompanyContact c)
    {
        db=this.getWritableDatabase();
        ContentValues values = new ContentValues();
    ...
    public void updatejobs3(CompanyContact c)
    {
        db=this.getWritableDatabase();
        ContentValues values = new ContentValues();
    ...
    public void updatejobs4(CompanyContact c)
    {
        db=this.getWritableDatabase();
        ContentValues values = new ContentValues();
        values.put(COLUMN_JOB_ID4,c.getJobId4());
        values.put(COLUMN_JOB_NAME4,c.getJobName4());
        values.put(COLUMN_JOB_TYPE4,c.getJobType4());
        values.put(COLUMN_SALARY4,c.getSalary4());
        db.update(TABLE_NAME,values,COLUMN_ID+" = ?",new String[]{
                String.valueOf(c.getId())
        });
        db.close();
...
// return contact list
    ...
    public void delete(CompanyContact c)
    {
        db = this.getWritableDatabase();
        db.delete(TABLE_NAME, ROW_ID + "=" + c.id, null);
    }

    public void deletejob1(CompanyContact c)
    {
        db = this.getWritableDatabase();
        ContentValues values = new ContentValues();
        values.putNull(COLUMN_JOB_ID1);
        values.putNull(COLUMN_JOB_NAME1);
        values.putNull(COLUMN_JOB_TYPE1);
        values.putNull(COLUMN_SALARY1);
        db.update(TABLE_NAME,values,COLUMN_ID+" = ?",new String[]{
                String.valueOf(c.getId())
        });
        db.close();
    }
    public void deletejob2(CompanyContact c)
    {
        db = this.getWritableDatabase();
        db.delete(TABLE_NAME, ROW_ID + "=" + c.id, null);
    }
    public void deletejob3(CompanyContact c)
    {
        db = this.getWritableDatabase();
        db.delete(TABLE_NAME, ROW_ID + "=" + c.id, null);
    }
    public void deletejob4(CompanyContact c)
    {
        db = this.getWritableDatabase();
        db.delete(TABLE_NAME, ROW_ID + "=" + c.id, null);
    }
