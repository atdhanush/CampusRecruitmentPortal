...
public class Company_update_details_by_admin extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.company_update_details_by_admin);
        ...
        DatabaseHelperCompany helper = new DatabaseHelperCompany(Company_update_details_by_admin.this);
        ...
        mButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (mfullName.getText().toString().isEmpty() || mUserId.getText().toString().isEmpty() || mRank.getText().toString().isEmpty() || mEmailId.getText().toString().isEmpty() || mContactNo.getText().toString().isEmpty() || mAddress.getText().toString().isEmpty()) {
                    ...
                    Intent i = new Intent(Company_update_details_by_admin.this, ManageCompany.class);
